...
export class EmployesService {
  ...
  public getEmployes(): Observable<Employee[]> {
    return this.http.get(this.employeesUrl,{headers: this.getThymeApiHeaders()}).pipe(map(res => this.mapEmployesFromApi(res)));
  }
  ...
  public updateEmployee(employee : Employee) : Observable<any>{
    ...
    return this.http.post(fullSaveUrl, {this:this.getThymeApiHeaders})
      .pipe(map(res => res));
  }

export class ThymeConstants {
    ...
    public static TIME_STAMP_FORM_VIEW : string = "timeStampForm";
    public static TIME_SICK_NOTE_FORM_VIEW : string = "sickNoteForm";
    public static TIME_HOLIDAYS_FORM_VIEW : string = "holidaysForm";

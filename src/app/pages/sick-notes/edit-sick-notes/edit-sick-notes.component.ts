...
@Component({
  selector: 'ngx-edit-sick-notes',
  templateUrl: './edit-sick-notes.component.html',
  styleUrls: ['./edit-sick-notes.component.scss']
})
export class EditSickNotesComponent implements OnInit {
